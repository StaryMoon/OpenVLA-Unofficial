...
[Paper](https://arxiv.org/abs/2406.09246) · [PDF](https://arxiv.org/pdf/2406.09246) · [Issues](https://github.com/StaryMoon/OpenVLA-Unofficial/issues) · [Release](https://github.com/StaryMoon/OpenVLA-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="OpenVLA-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper/project page screenshot, [Paper](https://arxiv.org/abs/2406.09246). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>
...
| Venue / Source | VLA Robotics / arXiv 2024 |
| Focus | This repository organizes a PyTorch implementation for OpenVLA: An Open-Source Vision-Language-Action Model, focusing on open-source vision-language-action modeling for generali... |
...
This repository organizes a PyTorch implementation for **OpenVLA: An Open-Source Vision-Language-Action Model**, focusing on open-source vision-language-action modeling for generalist robotic manipulation. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```bash
git clone https://github.com/StaryMoon/OpenVLA-Unofficial.git
cd OpenVLA-Unofficial
python -m venv .venv
...
```python
import torch
from openvla_unofficial import ModelConfig, UnofficialModel, reconstruction_loss
...
```python
import torch
from openvla_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables | [arXiv paper](https://arxiv.org/abs/2406.09246) |
| Ablation study | Experiment / ablation sections | [arXiv paper](https://arxiv.org/abs/2406.09246) |
| Qualitative examples | Main paper figures and appendix | [arXiv PDF](https://arxiv.org/pdf/2406.09246) |
...
@article{OpenVLA_2024,
  ...
  author  = {Moo Jin Kim and Karl Pertsch and Siddharth Karamcheti and Ted Xiao and Ashwin Balakrishna and Suraj Nair and Rafael Rafailov and Ethan Foster and others},
...
- Thanks to the authors of **OpenVLA: An Open-Source Vision-Language-Action Model** for the original research.
...
pytorch, unofficial-implementation, reproduction, openvla, vision-language-action, robotics, robot-manipulation
